...
public class EncriptacionAES {
    ...
    public String desencriptar(ResultSet resultadoConsulta, String claveEncriptacion) {
        throw new UnsupportedOperationException("Not supported yet."); 
    }

    public String desencriptar(PreparedStatement sqlConsultPasswordClieneteDB, String claveEncriptacion) {
        throw new UnsupportedOperationException("Not supported yet.");
    }
